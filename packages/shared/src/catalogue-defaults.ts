...
export const DEFAULT_CATALOGUE: CatalogueSeed[] = [
  // Hydration
  { slug: 'water-bottle', group: 'hydration', name: { en: 'Sealed water bottle', hi: 'सीलबंद पानी की बोतल' }, icon: 'droplet', unit: 'bottle', altUnits: ['litre'], sealedRequired: true, expiryRelevant: true, maxRequestQty: 6, maxOfferQty: 100 },
  { slug: 'water-pack', group: 'hydration', name: { en: 'Packaged water container', hi: 'पैकेज्ड पानी का डिब्बा' }, icon: 'droplet', unit: 'packet', sealedRequired: true, maxRequestQty: 4, maxOfferQty: 50 },
  { slug: 'ors', group: 'hydration', name: { en: 'Oral rehydration sachet (sealed)', hi: 'ओआरएस पाउच (सीलबंद)' }, icon: 'droplet', unit: 'packet', sealedRequired: true, expiryRelevant: true, restricted: true, warningKey: 'safety.noOpened', maxRequestQty: 4, maxOfferQty: 30 },
  // Food
  ...
  { slug: 'meal', group: 'food', name: { en: 'Packaged meal', hi: 'पैक किया हुआ भोजन' }, icon: 'utensils', unit: 'meal', sealedRequired: true, maxRequestQty: 4, maxOfferQty: 50 },
  ...
  // Shelter & rest
  { slug: 'blanket', group: 'shelter', name: { en: 'Blanket', hi: 'कंबल' }, icon: 'bed', unit: 'blanket', maxRequestQty: 3, maxOfferQty: 30 },
  { slug: 'sleeping-mat', group: 'shelter', name: { en: 'Sleeping mat', hi: 'सोने की चटाई' }, icon: 'bed', unit: 'piece', maxRequestQty: 2, maxOfferQty: 20 },
  { slug: 'tarpaulin', group: 'shelter', name: { en: 'Tarpaulin', hi: 'तिरपाल' }, icon: 'tent', unit: 'piece', maxRequestQty: 2, maxOfferQty: 15 },
  { slug: 'towel', group: 'shelter', name: { en: 'Towel', hi: 'तौलिया' }, icon: 'towel', unit: 'piece', maxRequestQty: 2, maxOfferQty: 20 },
  { slug: 'mosquito-net', group: 'shelter', name: { en: 'Mosquito net', hi: 'मच्छरदानी' }, icon: 'shield', unit: 'piece', maxRequestQty: 2, maxOfferQty: 15 },
  ...
  { slug: 'raincoat', group: 'shelter', name: { en: 'Raincoat', hi: 'रेनकोट' }, icon: 'cloud-rain', unit: 'piece', maxRequestQty: 2, maxOfferQty: 20 },
  { slug: 'umbrella', group: 'shelter', name: { en: 'Umbrella', hi: 'छाता' }, icon: 'umbrella', unit: 'piece', maxRequestQty: 1, maxOfferQty: 15 },
  // Hygiene
  ...
  // Lighting & power
  { slug: 'torch', group: 'power', name: { en: 'Torch', hi: 'टॉर्च' }, icon: 'flashlight', unit: 'piece', maxRequestQty: 2, maxOfferQty: 15 },
  { slug: 'batteries', group: 'power', name: { en: 'Batteries', hi: 'बैटरियाँ' }, icon: 'battery', unit: 'battery', maxRequestQty: 8, maxOfferQty: 60 },
  { slug: 'power-bank', group: 'power', name: { en: 'Power bank (charged)', hi: 'पावर बैंक (चार्ज किया हुआ)' }, icon: 'battery-charging', unit: 'piece', maxRequestQty: 1, maxOfferQty: 10 },
  { slug: 'charging-cable', group: 'power', name: { en: 'Charging cable', hi: 'चार्जिंग केबल' }, icon: 'cable', unit: 'piece', maxRequestQty: 2, maxOfferQty: 15 },
  { slug: 'charging-adapter', group: 'power', name: { en: 'Charging adapter', hi: 'चार्जिंग अडैप्टर' }, icon: 'plug', unit: 'piece', maxRequestQty: 1, maxOfferQty: 10 },
  // Clothing
  { slug: 'shirt', group: 'clothing', name: { en: 'Shirt', hi: 'कमीज़' }, icon: 'shirt', unit: 'piece', maxRequestQty: 3, maxOfferQty: 25 },
  { slug: 'jacket', group: 'clothing', name: { en: 'Jacket', hi: 'जैकेट' }, icon: 'shirt', unit: 'piece', maxRequestQty: 2, maxOfferQty: 15 },
  ...
  { slug: 'cold-pack', group: 'first_aid', name: { en: 'Sealed cold pack', hi: 'सीलबंद कोल्ड पैक' }, icon: 'snowflake', unit: 'piece', sealedRequired: true, maxRequestQty: 2, maxOfferQty: 15 },
  // Misc
  { slug: 'stationery', group: 'misc', name: { en: 'Stationery', hi: 'स्टेशनरी' }, icon: 'pencil', unit: 'item', maxRequestQty: 10, maxOfferQty: 100 },
  { slug: 'notebook', group: 'misc', name: { en: 'Notebook', hi: 'नोटबुक' }, icon: 'notebook', unit: 'piece', maxRequestQty: 3, maxOfferQty: 30 },
  { slug: 'rope', group: 'misc', name: { en: 'Rope', hi: 'रस्सी' }, icon: 'cable', unit: 'roll', maxRequestQty: 2, maxOfferQty: 15 },
  { slug: 'container', group: 'misc', name: { en: 'Reusable container', hi: 'दोबारा इस्तेमाल होने वाला डिब्बा' }, icon: 'box', unit: 'piece', maxRequestQty: 3, maxOfferQty: 25 },
];
